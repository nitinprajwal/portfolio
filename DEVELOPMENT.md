...
```bash
git clone https://github.com/ncdai/nitinr.live.git minimal-portfolio
...
```bash
npx shadcn@latest add https://nitinr.live/r/utils.json
npx shadcn@latest add https://nitinr.live/r/theme-switcher.json
npx shadcn@latest add https://nitinr.live/r/flip-sentences.json
npx shadcn@latest add https://nitinr.live/r/apple-hello-effect.json
npx shadcn@latest add https://nitinr.live/r/wheel-picker.json
npx shadcn@latest add https://nitinr.live/r/use-controllable-state.json
```
